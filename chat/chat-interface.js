...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function updateChatContext(section, label) {
    ...
    const prompts = {
      ...
      experience:
        "Summarize Corey's professional experience timeline for recruiters. List roles in reverse chronological order with title, company, dates (start–end), and a 1–2 line impact statement. Highlight system ownership, cross-functional work with GTM and finance, data integrity, automation, and measurable outcomes when present. Use 4–7 concise bullets. Facts only from the résumé JSON; omit unknowns. Utilize markdown formatting and focus on fantastic readability for this section.",
      projects:
