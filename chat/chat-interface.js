...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function updateChatContext(section, label) {
    ...
    const prompts = {
      about:
        "Provide a concise 'About Corey' summary for hiring managers. Emphasize revenue systems ownership, data governance, and how Corey reduces operational risk. Include 4–7 short bullets. Third person. Use only facts from the résumé JSON. Omit unknowns.",
      experience:
        "Summarize Corey's professional experience timeline for recruiters. List roles in reverse chronological order. Format as nested markdown bullets with clear spacing: each role is a top-level bullet in the format **Title - Company | Start-End** (use dates exactly as provided), followed by 2-4 indented sub-bullets for impact and responsibilities. Use a blank line between roles for readability. If key_responsibilities_by_category exists, group the sub-bullets by category (bold category label as a sub-bullet, then 1-2 bullets beneath it). Avoid paragraphs entirely. Highlight system ownership, cross-functional work with GTM and finance, data integrity, automation, and measurable outcomes when present. Facts only from the resume JSON; omit unknowns.",
      projects:
        "Summarize Corey's flagship projects. Emphasize platform work, governed data models, automation, and reliability. Include project names, timeline, goals, outcomes/metrics, and tech stack. Use 4–8 bullets, grouped if helpful. Third person. Facts only from the résumé JSON. Omit unknowns. Output the project cards at the end. Output live URLs with project details if available.",
      expertise:
        "Summarize Corey's technical skills and expertise, highlighting strengths that matter to hiring managers for revenue systems, RevOps engineering, and data governance roles. Group by categories (Revenue Systems, Integrations/Automation, Frontend, Backend, Cloud/DevOps, Data/AI, Tools). Note proficiency or depth when available and top tools. 5–10 bullets, concise. Third person. Facts only from the résumé JSON. Omit unknowns.",
      education:
      ...
      achievements:
        "List Corey's notable achievements and impact highlights relevant to hiring managers. Focus on data integrity improvements, automation that reduces manual cleanup, governed content models, rebuilds, launches, CI/CD reliability, performance gains, and attribution readiness. Derive only from the résumé JSON (career.key_responsibilities, summaries). Use 4–7 crisp bullets.",
      contact:
    ...
    const prompt =
      prompts[section] ||
      'Give a concise overview of Corey for a hiring manager. Use short bullets and only facts from the résumé JSON. Emphasize revenue systems, data governance, and automation.';
  ...
  function hydrateProfilePanel(data) {
    try {
      ...
      if (roleEl) roleEl.textContent = 'Revenue Systems Engineer';
  ...
  function getContextualResponse(section) {
    const contextMessages = {
      about:
        "I can share a quick summary of Corey's background and what he owns in revenue systems. What would you like to focus on?",
      projects:
        "I can walk through Corey's platform work and key projects. Which one do you want to start with?",
      expertise:
        "I can break down Corey's expertise in data governance, integrations, automation, and engineering. What area matters most for your role?",
      contact:
        "I can share Corey's contact details and links from his résumé. What do you need?",
    };
    ...
    setTimeout(() => {
      ...
      if (!chatMessages.querySelector('.welcome-message')) {
        ...
        wrap.innerHTML = `
          ...
          <p>I have access to his complete résumé and can provide detailed information about his revenue systems work, data governance approach, and platform experience.</p>
          <div class="suggestion-chips">
            <button class="suggestion-chip">What revenue systems has Corey owned?</button>
            <button class="suggestion-chip">What data governance artifacts has he built?</button>
            <button class="suggestion-chip">How does he handle web-to-CRM data flow?</button>
            <button class="suggestion-chip">Show me his automation and platform work</button>
          </div>`;
